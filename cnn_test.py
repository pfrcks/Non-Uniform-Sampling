...
if args.cross_val is True:
    ...
    for val in batch_size:
        ...
        f = open('batch/'+str(args.dataset)+'_'+str(args.sample_type)+'_'+str(val)+'.train.log', 'w')
        ff = open('batch/'+str(args.dataset)+'_'+str(args.sample_type)+'_'+str(val)+'.val.log', 'w')
        fff = open('batch/'+str(args.dataset)+'_'+str(args.sample_type)+'_'+str(val)+'.test.log', 'w')
        train_vals = []
        test_vals = []
        val_vals = []
        if args.dataset == 'mnist':
