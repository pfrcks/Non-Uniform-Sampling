...
val_vals = []
duration_vals = []
f = open('results/fc_'+str(args.dataset)+'_'+str(args.sample_type)+'.train.log', 'w')
ff = open('results/fc_'+str(args.dataset)+'_'+str(args.sample_type)+'.test.log', 'w')
fff = open('results/fc_'+str(args.dataset)+'_'+str(args.sample_type)+'.val.log', 'w')
ffff = open('results/fc_'+str(args.dataset)+'_'+str(args.sample_type)+'.dur.log', 'w')
